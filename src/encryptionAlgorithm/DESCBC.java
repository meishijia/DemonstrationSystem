...
public class DESCBC {
     ...
     * padding.
     * 将8个字节转换成64位长整形，如果提供的字节数组不包含从offset开始的8个元素，则丢失的字节被视为零填充。
     */
    ...
    /**
     * by @meishijia
     * 增加一个String encrypt(String plaintext,String keyStr)
     * @param args
     */
    ...
    /**
     * by @meishijia
     * 增加一个String decrypt(String ciphertext,String keyStr) 
     */
    public static String decrypt(String ciphertext,String keyStr) {
    	byte[] cipherBytes = parseBytes(ciphertext);
    	String keyConv = convertStringToHex(keyStr);
    	byte[] keyBytes = parseBytes(keyConv);
    ...
    public static void main(String[] args) {
    	...
    	String key = convertStringToHex("meishijia");
