...
public class jFrameTest {
	...
	public static void main(String[] args){
		...
		JTextArea plaintext = new JTextArea(10,20);
		JTextArea key = new JTextArea(10,20);
		...
		//处理凯撒加密
		itemCaeser.addActionListener(new ActionListener() {
		...
		//处理Plfyfair加密/解密
		itemPlayfair.addActionListener(new ActionListener() {
		...
		//处理维吉尼亚加密
		itemVigenere.addActionListener(new ActionListener() {
		...
		itemDes.addActionListener(new ActionListener() {
		...
		/*itemDes.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				//加密只能通过点击获取秘钥按钮才能加密，有待改进
				encrypt.addActionListener(new ActionListener() {
					
					@Override
					public void actionPerformed(ActionEvent e) {
						JButton getKey = new JButton("获取秘钥");
						box1.add(getKey);
						jf.setVisible(true);
						...
						getKey.addActionListener(new ActionListener() {
							...
							@Override
							public void actionPerformed(ActionEvent e) {
								String keyStr = DES.keyGenerator();
								key.setText(keyStr);
								String plain = plaintext.getText();
								String cipherStr = DES.desEncrypt(plain, keyStr);				
								ciphertext.setText(cipherStr);
							}
				...
				decrypt.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						String cipherStr = ciphertext.getText();
						String keyStr = key.getText();
						String plainStr = DES.desDecrypt(cipherStr, keyStr);
						plaintext.setText(plainStr);			
					}
				});
			}
		...
		*/
		...
		itemAes.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				encrypt.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						getKey.addActionListener(new ActionListener() {
							...
							@Override
							public void actionPerformed(ActionEvent e) {
								String keyStr = AES.keyGenerator();
								key.setText(keyStr);
								String plainStr = plaintext.getText();
								String cipherStr = AES.aesEncrypt(plainStr, keyStr);
								ciphertext.setText(cipherStr);
							}
						});	
					}
				...
				decrypt.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						String cipherStr = ciphertext.getText();
						String keyStr = key.getText();
						String plainStr = AES.aesDecrypt(cipherStr, keyStr);
						plaintext.setText(plainStr);
		...
		*/
		...
		itemRsa.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				
				JButton publicEncrypt = new JButton("公钥加密");
				JButton privateEncrypt = new JButton("私钥加密");
				JButton publicDecrypt = new JButton("公钥解密");
				JButton privateDecrypt = new JButton("私钥解密");
